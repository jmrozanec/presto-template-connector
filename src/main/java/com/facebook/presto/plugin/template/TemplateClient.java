...
package com.facebook.presto.plugin.template;

import com.facebook.presto.plugin.jdbc.*;
import com.facebook.presto.plugin.template.mock.TemplateDriver;
 ...
 */
public class TemplateClient extends BaseJdbcClient {
    private static final Logger log = Logger.getLogger(TemplateClient.class);

    @Inject
    public TemplateClient(JdbcConnectorId connectorId, BaseJdbcConfig config, TemplateConfig templateConfig) throws SQLException {
        /*
         ...
         */
        super(connectorId, config, "", new TemplateDriver());
    }
